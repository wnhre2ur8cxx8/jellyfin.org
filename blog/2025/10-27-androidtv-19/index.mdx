...
Welcome back to another release. This time, we've made progress in many aspects of the app. Some more visible than others. This blog post
will highlight some of the most notable changes. A complete list is available in the
...
no input has been detected for a configurable amount of time/episodes. If you don't choose to continue watching the app will automatically
close the video player, preventing entire series from being marked as watched overnight when you fall asleep!

## 📹 Video

Just like all other releases a lot of effort was put into our video player. While not all our work was ready for this release yet, a lot of
it was. We've made significant improvements in the detection of device HDR capabilities to more accurately transcode or direct play content.
For Dolby Vision content we do require Jellyfin 10.11 and media has to be rescanned for these changes to fully work.
Additionally we now support the VobSub and DVDSub subtitle formats without transcoding.
...
statistics, this affects less than 1% of our users. You will be able to keep using Jellyfin but won't be able to receive future app updates.
We recommend upgrading your device or using an external Android TV set-top box to receive future app updates.
